...
const UserDropdown = () => {
  ...
  const handleThemeSettings = event => {
    ...
    customizerEvents.dispatch(CUSTOMIZER_EVENTS.TOGGLE_CUSTOMIZER)
  }
              ...
              <ClickAwayListener onClickAway={e => handleDropdownClose(e)}>
                <MenuList>
                  ...
                  <MenuItem className='mli-2 gap-3' onClick={e => handleDropdownClose(e, '/profile')}>
                    ...
                    <Typography color='text.primary'>{t('userDropdown.profile')}</Typography>
                  </MenuItem>
                  <MenuItem className='mli-2 gap-3' onClick={e => handleDropdownClose(e)}>
                    <i className='tabler-settings' />
                    <Typography color='text.primary'>{t('userDropdown.settings')}</Typography>
                  </MenuItem>
                  <MenuItem className='mli-2 gap-3' onClick={handleThemeSettings}>
                    <i className='tabler-palette' />
                    <Typography color='text.primary'>{t('userDropdown.themeSettings')}</Typography>
                  </MenuItem>
