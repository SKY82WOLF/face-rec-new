    ...
    css`
      ...
      ${Stars} {
        & ${Star} {
          &:nth-of-type(1) {
            animation: ${css`
              ${startravel1} 15s linear infinite
            `};
            animation-delay: 0.4s;
          }
          &:nth-of-type(2) {
            animation: ${css`
              ${startravel2} 12s linear infinite
            `};
            animation-delay: 0.2s;
          }
          &:nth-of-type(3) {
            animation: ${css`
              ${startravel3} 18s linear infinite
            `};
            animation-delay: 0s;
          }
        }
      ...
      ${ShootingStarWrapper} {
        ...
        animation: ${css`
          ${shootingstartravel} 24s linear infinite
        `};
        animation-delay: 6s;
      }
      ${ShootingStar} {
...
export const Star = styled.div`
  ...
  &::after {
    ...
    animation: ${css`
      ${growbrighter} 1s linear alternate infinite
    `};
    left: 50%;
    top: 50%;
  }
...
export const ShootingStar = styled.div`
  ...
  box-shadow:
    -5px 0 20px 2px rgba(237, 155, 61, 0.7),
    0 0 15px 5px rgba(237, 155, 61, 0.5);
  ...
  &::after {
    ...
    box-shadow:
      10px 0 10px 1px rgba(237, 155, 61, 0.5),
...
export const Cloud = styled.div`
  ...
  &:nth-of-type(1) {
    ...
    top: 5px;
    animation: ${css`
      ${cloudtravel1} 22s linear infinite
    `};
  ...
  &:nth-of-type(2) {
    ...
    top: 26px;
    animation: ${css`
      ${cloudtravel2} 18s linear infinite
    `};
  ...
  &:nth-of-type(3) {
    ...
    top: 48px;
    animation: ${css`
      ${cloudtravel3} 30s linear infinite
    `};
