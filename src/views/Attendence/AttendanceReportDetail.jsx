...
const AttendanceReportDetail = ({
  ...
  // Add entry/exit label to top-level modal info for attendance context
  const entryExitLabel = reportData.isEntryReport
    ? { label: 'نوع', value: <Chip label='ورود' size='small' sx={{ bgcolor: '#4caf50', color: '#fff' }} /> }
    : reportData.isExitReport
      ? { label: 'نوع', value: <Chip label='خروج' size='small' sx={{ bgcolor: '#f44336', color: '#fff' }} /> }
      : null
